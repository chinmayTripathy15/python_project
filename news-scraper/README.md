...
│── headlines.txt       # Output file (optional)
│── headlines.csv       # Output file (optional)
...
1. Global markets react to...
2. AI trends continue to grow...
3. New policies announced...
```
...
**Chinmay**
CSE Student | Python Learner | Aspiring Data Analyst
